package com.nnamanistephen.todo.feature_todo.data.mapper
...
/* Here we create extension functions that we will use to connect the data classes to one another
...
/* Because we are working with list will create an extension function here for our list
